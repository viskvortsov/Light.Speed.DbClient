...
public class TranslationsTable : IConnectedTable
{
    ...
    public TranslationsTable(PropertyInfo property, string queryName)
    {
        ...
        _tableReflection = new TableReflection(rowType, queryName);
